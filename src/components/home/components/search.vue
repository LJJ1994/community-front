...
<style scoped>
  ...
  .search-no-input .hot-search {
    font-size: 14px;
    color: rgba(23, 29, 40, 0.5);
  }
  .search-no-input .hot-search p {
    margin-left: 10px;
  }
  .hot-search .hot-list {
    margin-top: 10px;
  ...
  .hot-list .record-group {
    position: relative;
    width: 300px;
    height: 100px;
  }
  .hot-list .record-group .record-item {
    float: left;
    font-size: 14px;
    color: #333333;
    margin-left: 12px;
  ...
  .search-record .delete-record img {
    width: 100%;
    height: 100%;
  }
  .search-record-list {
